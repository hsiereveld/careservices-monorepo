/*
  ...
  1. New Tables
    - `bookings` - Core booking table with all necessary fields
    - `booking_status_history` - Track status changes over time
    - `service_providers` - Professionals who provide services
    - `provider_services` - Link providers to services they offer
    - `booking_reviews` - Customer reviews after service completion
  ...
  3. Relationships
    - Link bookings to users (customers)
    - Link bookings to service providers
    - Link bookings to services
    - Track status changes with timestamps
*/

-- Create booking statuses enum
