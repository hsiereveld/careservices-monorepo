/*
  # Provider Services Customization

  1. New Fields
    - Add custom fields to provider_services table for personalization
    - Fields include custom name, descriptions, pricing, and more
  
  2. Indexing
    - Add index for faster queries on custom_name field
  
  3. Security
    - Add policy for professionals to manage their own services
*/
