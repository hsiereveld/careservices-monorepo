...
export function BookingList({ bookings, loading, error, onUpdateStatus }: BookingListProps) {
  ...
  const canSeeEarnings = userRole === 'professional' || userRole === 'admin' || userRole === 'backoffice';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="relative">
          <CalendarIcon className="w-5 h-5 text-text-light absolute left-4 top-1/2 transform -translate-y-1/2" />
          <select
            value={dateFilter}
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <div className="bg-white rounded-lg p-4 space-y-3">
                          ...
                          {/* Urgency */}
                          <div className="flex items-start space-x-2">
                            <ClockIcon className="w-4 h-4 text-text-light mt-0.5" />
                            <div>
