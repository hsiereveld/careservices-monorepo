...
export function BackofficeDashboard() {
  ...
  const { isBackOffice, hasAdminPrivileges, loading: roleLoading } = useAdmin();
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background-primary via-background-accent to-primary-50">
        <div className="text-center">
          ...
          <div className="text-text-primary text-xl font-medium">Backoffice dashboard laden...</div>
        </div>
      </div>
    );
  }
  ...
  const tabs = [
    ...
    { id: 'services', label: 'Diensten', icon: Package },
    { id: 'categories', label: 'Categorieën', icon: Tag },
    { id: 'bookings', label: 'Boekingen', icon: Calendar },
    { id: 'discounts', label: 'Kortingen', icon: Tag },
    { id: 'bundles', label: 'Bundels', icon: Package },
    { id: 'subscriptions', label: 'Abonnementen', icon: Package },
    { id: 'emails', label: 'E-mails', icon: Mail },
    { id: 'contact', label: 'Contactberichten', icon: MessageSquare },
    { id: 'invoicing', label: 'Facturatie', icon: FileText },
    { id: 'payouts', label: 'Uitbetalingen', icon: CreditCard },
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-text-secondary text-lg">
                Beheer klanten, professionals en diensten
              </p>
            </div>
