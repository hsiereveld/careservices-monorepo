...
export function ProfessionalDashboard() {
  ...
  const fetchProviderData = async () => {
    ...
    try {
      ...
      const isProfileIncomplete = !providerData.business_name || 
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-6 mb-8">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold text-yellow-800 mb-2">Voltooi je profiel</h2>
                <p className="text-yellow-700 mb-4">
                  Je profiel is nog niet volledig ingevuld. Vul je bedrijfsgegevens in om zichtbaar te worden voor potentiële klanten en diensten aan te kunnen bieden.
                </p>
                <button
                  onClick={handleEditProfile}
                  className="bg-yellow-600 hover:bg-yellow-700 text-white px-6 py-3 rounded-xl font-medium transition-colors inline-flex items-center space-x-2"
                >
