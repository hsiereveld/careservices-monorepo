...
import { Mail, Lock, AlertCircle, CheckCircle, User, ArrowRight, Shield, Heart, Clock, Star, MapPin, Users, Home, Phone, Calendar } from 'lucide-react';
...
export function SignupPage() {
  ...
  const [selectedRole, setSelectedRole] = useState<'professional' | null>(null);
  ...
  const handleRoleSelect = (role: 'professional') => {
  ...
  const getRoleDescription = () => {
    return 'Je kunt nu diensten aanbieden en je eigen planning beheren';
  };
            ...
            <div className="bg-primary-50 rounded-2xl p-6 mb-8 text-left">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-primary">Stel je diensten in</h4>
                    <p className="text-text-secondary text-sm">Configureer welke diensten je wilt aanbieden</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-primary">Ontvang je eerste boeking</h4>
                    <p className="text-text-secondary text-sm">Begin met het aanbieden van je diensten aan klanten</p>
                  </div>
                </div>
              </div>
            </div>
