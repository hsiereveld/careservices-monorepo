/*
  # Fix User Roles and Display Names

  1. Role Management
    - Update role constraint to only allow valid roles: admin, client, professional, backoffice
    - Convert existing 'user' roles to 'client'
  
  2. Display Functions
    - Create function to get role display names
    - Update admin users overview function to include display names
...
-- Recreate the admin users overview function with the new display names column
