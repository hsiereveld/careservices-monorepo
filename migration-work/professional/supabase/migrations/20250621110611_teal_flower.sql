/*
  ...
  1. Changes
     - Update user_roles constraint to remove 'user' role and only allow valid roles
     - Convert existing 'user' roles to 'client' roles
     - Add role display name functions
     - Update admin users overview function to include role display names
