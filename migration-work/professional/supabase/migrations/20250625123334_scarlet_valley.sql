/*
  ...
  1. New Fields
    - Adds custom fields to provider_services table for professionals to customize their service offerings
    - Adds index for faster queries on custom_name
  2. Security
    - Adds policy for professionals to manage their own services
*/
