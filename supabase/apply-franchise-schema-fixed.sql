-- ============================================================================
-- FRANCHISE SCHEMA MIGRATION SCRIPT (FIXED VERSION)
-- ============================================================================
-- 
-- Dit script past het franchise schema toe op een bestaande Supabase database.
-- 
-- VOORAF: Voer eerst supabase/fix-missing-tables.sql uit!
-- 
-- ============================================================================
...
-- 4. Reviews table uitbreiden (alleen als de tabel bestaat)
DO $$ 
BEGIN
...
-- 5. Payments table uitbreiden (alleen als de tabel bestaat)
DO $$ 
BEGIN
...
-- Review indexes (extended) - alleen als tabel bestaat
DO $$ 
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'reviews') THEN
...
-- Payment indexes (extended) - alleen als tabel bestaat
DO $$ 
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'payments') THEN
